...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'bluth' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'bluth' ),
		'repeat-y'  => __( 'Repeat Vertically', 'bluth' ),
		'repeat'    => __( 'Repeat All', 'bluth' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'bluth' ),
		'top center'    => __( 'Top Center', 'bluth' ),
		'top right'     => __( 'Top Right', 'bluth' ),
		'center left'   => __( 'Middle Left', 'bluth' ),
		'center center' => __( 'Middle Center', 'bluth' ),
		'center right'  => __( 'Middle Right', 'bluth' ),
		'bottom left'   => __( 'Bottom Left', 'bluth' ),
		'bottom center' => __( 'Bottom Center', 'bluth' ),
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'bluth' ),
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'bluth' ),
		'italic'      => __( 'Italic', 'bluth' ),
		'bold'        => __( 'Bold', 'bluth' ),
		'bold italic' => __( 'Bold Italic', 'bluth' )
	);
